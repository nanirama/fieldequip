      ...
      <section className="mx-auto max-w-7xl pt-14 sm:pt-16 mt-20 px-4 lg:pt-24">
        ...
        <div
          className={[
            ...
            lastUpdated ? "lg:flex-row lg:items-end lg:justify-between" : "",
            showMetaPill ? "mt-5" : "",
          ].join(" ")}
        >
          <h1 className="max-w-6xl font-manrope text-3xl font-semibold tracking-tight text-[#020210] sm:text-4xl lg:text-[2rem] lg:leading-tight">
            {data.name}
          </h1>
          {lastUpdated ? (
